...
let totalValue = calculateTotalValue(cost, percentageAmount,customers);
...
function calculateTotalValue(cost, percentageAmount,customers) {
  return Math.round((cost + percentageAmount)/customers)
}
